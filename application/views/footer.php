        ...
        <div class="message-box animated fadeIn" data-sound="alert" id="mb-signout">
            <div class="mb-container">
                <div class="mb-middle">
                    <div class="mb-title"><span class="fa fa-sign-out"></span> Keluar <strong>!?</strong></div>
                    <div class="mb-content">
                        <p>Apakah Anda Yakin Ingin Keluar ? \(^o^\)</p>                    
                        <p>Tekan Ya Jika Ingin Keluar ~(-,-)~</p>
                    </div>
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="<?php echo site_url() ?>/admin/user_logout" class="btn btn-success btn-lg">Yes</a>
    ...
    <!-- START SCRIPTS -->
		...
		<script type="text/javascript" src="<?php echo base_url(); ?>assets/js/demo_tables.js"></script> 		
