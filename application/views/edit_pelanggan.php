                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url() ?>/Pelanggan/update_process" method="post" enctype="multipart/form-data"> 
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title"><strong>Form</strong> Edit Customer</h3>
                                ...
                                <div class="panel-body">                                                                        
                                                ...
                                                <input type="hidden" name="id_customer" class="form-control" value="<?php echo $datapelanggan->id_customer ?>" />
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="nama_customer" class="form-control" value="<?php echo $datapelanggan->nama_customer ?>" />
                                            </div>                                            
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="telp_customer" value="<?php echo $datapelanggan->telp_customer ?>" class="form-control"/>
                                            </div>                                            
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-6 col-xs-12">                                            
                                            <div class="input-group">
                                                <span class="input-group-addon"><span class="fa fa-pencil"></span></span>
                                                <input type="text" name="keterangan" value="<?php echo $datapelanggan->keterangan ?>" class="form-control"/>
                                            </div>                                            
