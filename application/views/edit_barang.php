 	...
 	<div class="page-content-wrap">
 		...
 		<div class="row">
 			<div class="col-md-12">
 				...
 				<form class="form-horizontal" action="<?php echo site_url() ?>/Barang/update_process" method="post"
 					...
 					<div class="panel panel-default">
 							...
 							<div class="col-md-6 col-xs-12">
 								<div class="input-group">
 									...
 									<input type="text" name="nama_barang" class="form-control"
 										value="<?php echo $databarang->nama_barang ?>" />
 								</div>
 							...
 							<div class="col-md-6 col-xs-12">
 								<div class="input-group">
 									<div class="form-check">
 										<input class="form-check-input" type="radio" name="jenis_barang"
 											id="exampleRadios1" value="Banner" <?php if($databarang->jenis_barang=="Banner") echo "checked"; ?>>
 									...
 									<div class="form-check">
 										<input class="form-check-input" type="radio" name="jenis_barang"
 											id="exampleRadios2" value="Kertas" <?php if($databarang->jenis_barang=="Kertas") echo "checked"; ?>>
 						...
 						<div class="form-group">
 							...
 							<div class="col-md-6 col-xs-12">
 								<div class="input-group">
 									<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
 									<input type="number" name="panjang"  value="<?php echo $databarang->panjang ?>" class="form-control" />
 						...
 						<div class="form-group">
 							...
 							<div class="col-md-6 col-xs-12">
 								<div class="input-group">
 									<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
 									<input type="number" name="lebar"  value="<?php echo $databarang->lebar ?>" class="form-control" />
 									<span class="input-group-addon">cm</span>
 								</div>
 						...
 						<div class="form-group">
 							...
 							<div class="col-md-6 col-xs-12">
 								<div class="input-group">
 									<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
 									<input type="text" name="jml_barang" value="<?php echo $databarang->jml_barang ?>"
 										class="form-control" />
 								</div>
 						...
 						<div class="form-group">
 							...
 							<div class="col-md-6 col-xs-12">
 								<div class="input-group">
 									<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
 									<input type="text" name="satuan" value="<?php echo $databarang->satuan ?>"
 										class="form-control" />
 								</div>
 							...
 							<div class="col-md-6 col-xs-12">
 								<div class="input-group">
 									...
 									<input type="date" name="tgl_diterima"
 										value="<?php echo $databarang->tgl_diterima ?>" class="form-control" />
 								</div>
 						...
 						<div class="form-group">
 							...
 							<div class="col-md-6 col-xs-12">
 								<div class="input-group">
 									<span class="input-group-addon"><span class="fa fa-pencil"></span></span>
 									<input type="text" name="supplier" value="<?php echo $databarang->supplier ?>"
 										class="form-control" />
 								</div>
